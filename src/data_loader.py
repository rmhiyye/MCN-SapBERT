...
def data_loader():
    ...
    train_ref_path = os.path.join(path, 'train/cui2name.txt')
    test_ref_path = os.path.join(path, 'gold/cui2name.txt')
    ...
    test_dataset, test_cui_less_dict, test_span_split = mention2concept(test_note_path, test_norm_path, test_small_file, with_text = False)    
    ...
    return train_dataset, test_dataset, validation_dataset, train_ref_dataset, test_ref_dataset, train_cui_less_dict, train_span_split, test_span_split
